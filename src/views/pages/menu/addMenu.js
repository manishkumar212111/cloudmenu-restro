...
const AddMenu = (props) => {
    ...
    const handleChange = (e, key, value) => {
      ...
      const validateField = (key, value) => {
        ...
        switch (key) {
          ...
          case "coverImage":
            return validateUtility.required(fieldObj.coverImage || value || "");
    ...
    <>
      ...
      <div class="form-group d-flex justify-content-space-between mb-4">
        {bannerImg.map(itm => (
            <><img
              onClick={(e) => handleChange(e, "bannerImage", itm)}
              src={itm}
              class="banner-img mx-auto d-inline mb-3"
              alt="..."
              style={ fieldObj.bannerImage == itm ? { borderRadius : "2.25rem"} : {}}
            /></>
        ))} 
      ...
      <div class="form-group col-6 mx-auto">
        {props.menu_detail_loading ? <CSpinner /> : <button onClick={handleClick} type="button" class="btn add-menu-btn">
          CREATE
        </button>}
      </div>
    </>
