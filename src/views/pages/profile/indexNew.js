...
const Profile = (props) => {
    ...
    useEffect(() => {
      props.fieldObj && props.fieldObj.id && setfieldObj({
        ...
        props.fieldObj && props.fieldObj.id && setPlan({ name : props.fieldObj.user.planName, detail: props.fieldObj.user.planDetail});
    }, [props.fieldObj]);
    ...
    const handleClick = () => {
        ...
        if(isEdit){
            ...
            props.UpdateRestaurantById(isEdit , {...fieldObj, bankDetail: JSON.stringify(fieldObj.bankDetail)})
            return;
        }
        fieldObj.ccode ="+91";
            ...
            <div class="row restaurant-details-form-heading py-3 px-4">
                ...
                <div class="row py-4">
                    <div class="col-6 px-4">
                        ...
                        <div class="form-group mb-4">
                            <label for="table-no" class="input-label" >Number of Tables</label>
                            <input type="text" class="form-control py-2 pl-3 form-input" id="noOfTable" name="noOfTable" value={fieldObj.noOfTable} onChange={(e) => handleChange(e , 'noOfTable')}/>
                            {!errorObj.noOfTable.error && <CFormText className="help-block error">{errorObj.noOfTable.msg}</CFormText>}
                        </div>
                    ...
                    <div class="col-6 px-4">
                        ...
                        <div class="form-group mb-4">
                            <label for="restaurantLogoUpload" class="form-label input-label">Upload Logo</label>
                            <div class="col-lg-8 col-md-10 col-sm-11 col-11 px-0 imageUploadInput-container">
                                <input class="form-control imageUploadInput" type="file"
                                    id="logoImg" name="logoImg" onChange={(e) => handleFileUpload(e , 'logoImg')} />
                                <div style={{ width: 260, height : 130}}
                                    class="restaurantLogoUploadBackground d-flex justify-content-center align-items-center">
                                    <img src={previewLogo ? previewLogo : fieldObj.logo_url ? (BASE_URL+fieldObj.logo_url) : ImagUpload} alt=""
                                       style={{ width: 260, height : 130}} class="restaurantLogoUploadBackground-icon" />
                                </div>
                            </div>
                            {!errorObj.logoImg.error && <CFormText className="help-block error">{errorObj.logoImg.msg}</CFormText>}
                        </div>

                        <div class="form-group mb-4">
                            <label for="restaurantBannerUpload" class="form-label input-label">Upload
                                Banner</label>
                            <div class="col-lg-8 col-md-10 col-sm-11 col-11 px-0 imageUploadInput-container">
                                <input class="form-control imageUploadInput" type="file"
                                    id="bannerImg" name="bannerImg" onChange={(e) => handleFileUpload(e , 'bannerImg')} />
                                
                                <div style={{ width: 260, height : 130}}
                                    class="restaurantLogoUploadBackground d-flex justify-content-center align-items-center">
                                    <img src={previewBanner ? previewBanner : fieldObj.banner_url ? (BASE_URL+fieldObj.banner_url) : ImagUpload} alt=""
                                       style={{ width: 260, height : 130}} class="restaurantLogoUploadBackground-icon" />
                                </div>
                            </div>
                            {!errorObj.bannerImg.error && <CFormText className="help-block error">{errorObj.bannerImg.msg}</CFormText>}
                        </div>
                ...
                <div class="row mt-4">
                    <div class="col-6 px-4">
                        <div class="form-group">
                            <div class="form-group mb-4">
                                <label for="table-no" class="input-label">State</label>
                                <input type="text" class="form-control py-2 pl-3 form-input" id="state" name="state" value={fieldObj.state} onChange={(e) => handleChange(e , 'state')} placeholder="State" />
                        ...
                        <div class="form-group mb-5">
                            ...
                            <input type="text" class="form-control py-2 pl-3 form-input" id="currency" name="currency" value={fieldObj.currency} onChange={(e) => handleChange(e , 'currency')}
                                placeholder="add currency" />
                            {!errorObj.currency.error && <CFormText className="help-block error">{errorObj.currency.msg}</CFormText>}
                        </div>
                        <div
                            class="form-check form-switch d-flex switch-container justify-content-space-between mb-3">
                            <div class="col-8 text-left">
                                <label class="form-check-label form-check-switch-label"
                                    for="flexSwitchCheckDefault">Activate Tax</label>
                            </div>
                            <div class="col-4 d-flex justify-content-end px-4">
                                <input class="form-check-input" id="tax" name="taxStatus" checked={fieldObj.taxStatus} onChange={(e) => handleTaxChange(e , 'taxStatus')}  type="checkbox" id="flexSwitchCheckDefault" />
                                {!errorObj.taxStatus.error && <CFormText className="help-block error">{errorObj.taxStatus.msg}</CFormText>}
                            </div>
                        </div>
                    </div>
                    <div class="col-6 px-4">
                        <div class="form-group">
                            <div class="mb-4">
                                <div class="form-group mb-4">
                                    <label for="table-no" class="input-label">City</label>
                                    <input type="text" id="city" name="city" value={fieldObj.city} onChange={(e) => handleChange(e , 'city')} class="form-control py-2 pl-3 form-input" id="city"
                        ...
                        <div class="form-group mb-4">
                            <label for="vat" class="input-label">Tax - VAT %</label>
                            <input type="text" class="form-control py-2 pl-3 form-input" id="taxRate" name="taxRate" value={fieldObj.taxRate} onChange={(e) => handleChange(e , 'taxRate')}
                                placeholder="add vat % ex - 15%" />
                            {!errorObj.taxRate.error && <CFormText className="help-block error">{errorObj.taxRate.msg}</CFormText>}
                        </div>
                    </div>
                </div>

                <div class="form-group d-flex justify-content-center mt-4">
                    <button type="button" onClick={handleClick} class="btn update-btn">UPDATE</button>
                </div>
        ...
        <div class="col-4 restaurant-details-right-container">
            <div class="row restaurant-details-right-container-plan bg-white py-3">
                ...
                <form action="" class="py-4">
                    ...
                    <div class="plan-name text-center py-2">
                        {plan?.name}
                    </div>
                    ...
                    <div class="form-group d-flex justify-content-center mt-4">
                        <button type="button" class="btn update-btn">UPGRADE</button>
                    </div>
            ...
            <div class="row restaurant-details-right-container-plan bg-white py-3 mt-5">
                ...
                <form action="" class="row py-4">
                    ...
                    <div class="col-6 px-4">
                        <div class="form-group mb-4">
                            <label for="bank-name" class="input-label">Bank Name</label>
                            <input type="text" class="form-control py-2 pl-3 form-input" id="bankName" name="bankName" value={fieldObj.bankDetail.bankName} onChange={(e) => handleBankChange(e , 'bankName')}
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control py-2 pl-3 form-input" id="IBAN" name="IBAN" value={fieldObj.bankDetail.IBAN} onChange={(e) => handleBankChange(e , 'IBAN')}
                    ...
                    <div class="col-6 px-4">
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control py-2 pl-3 form-input" id="companyName" name="companyName" value={fieldObj.bankDetail.companyName} onChange={(e) => handleBankChange(e , 'companyName')}
